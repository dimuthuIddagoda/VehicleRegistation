            ...
            <tbody>
                ...
                %>
                            <tr>
                                ...
                                <td><%= destination %></td>
                                <td>
                                    <a href='editBooking.jsp?id=<%= bookingId %>' class='btn btn-primary btn-sm btn-edit'>Edit</a>
                                    <a href='javascript:void(0);' onclick='confirmDelete(<%= bookingId %>)' class='btn btn-danger btn-sm btn-delete'>Delete</a>
                                </td>
                            </tr>
                <%
                        }
    ...
    <script>
        function confirmDelete(bookingId) {
            if (confirm("Are you sure you want to delete this booking?")) {
                window.location.href = "deleteBooking.jsp?id=" + bookingId;
            }
        }
    </script>
